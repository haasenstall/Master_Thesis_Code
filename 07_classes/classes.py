...
class trial:
    def __init__(self, nct_id, title, start_date, end_date, status, phase, condition, condition_tree_number, intervention, intervention_tree_number, sponsor, country, requests = None, request_rate = None):
        self.nct_id = nct_id
        self.title = title
    ...
    def __str__(self):
        return f"Trial({self.nct_id}, {self.title}, {self.start_date}, {self.end_date}, {self.status}, {self.phase}, {self.condition}, {self.condition_tree_number}, {self.intervention}, {self.intervention_tree_number}, {self.sponsor}, {self.country})"

    def __repr__(self):
        return f"Trial(nct_id={self.nct_id}, title={self.title}, start_date={self.start_date}, end_date={self.end_date}, status={self.status}, phase={self.phase}, condition={self.condition}, condition_tree_number={self.condition_tree_number}, intervention={self.intervention}, intervention_tree_number={self.intervention_tree_number}, sponsor={self.sponsor}, country={self.country})"
...
class trial_request:
    ...
    def __init__(self, request_id, nct_id, request_year, sponsor, lead_researcher, lead_institution, country = None):
    ...
    def __str__(self):
        return f"TrialRequest({self.request_id}, {self.nct_id}, {self.request_year}, {self.sponsor}, {self.lead_researcher}, {self.lead_institution}, {self.country})"
    
    def __repr__(self):
        return f"TrialRequest(request_id={self.request_id}, nct_id={self.nct_id}, request_year={self.request_year}, sponsor={self.sponsor}, lead_researcher={self.lead_researcher}, lead_institution={self.lead_institution}, country={self.country})"
    ...
    def get_country(self):
        """
        get the counrty by using the lead institution and map them to a country
        """
        if self.country:
            return self.country
        # Here you can implement a mapping from institution to country
